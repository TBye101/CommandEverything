...
std::ostream& dump_text_VkImageMemoryRequirementsInfo2KHR(const VkImageMemoryRequirementsInfo2KHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkExportSemaphoreCreateInfoKHR(const VkExportSemaphoreCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkImageSparseMemoryRequirementsInfo2KHR(const VkImageSparseMemoryRequirementsInfo2KHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkPhysicalDeviceVariablePointerFeaturesKHR(const VkPhysicalDeviceVariablePointerFeaturesKHR& object, const ApiDumpSettings& settings, int indents);
std::ostream& dump_text_VkMemoryRequirements2KHR(const VkMemoryRequirements2KHR& object, const ApiDumpSettings& settings, int indents);
...
#endif // VK_USE_PLATFORM_WIN32_KHR
std::ostream& dump_text_VkSparseImageMemoryRequirements2KHR(const VkSparseImageMemoryRequirements2KHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkPhysicalDeviceExternalFenceInfoKHR(const VkPhysicalDeviceExternalFenceInfoKHR& object, const ApiDumpSettings& settings, int indents);
std::ostream& dump_text_VkExternalFencePropertiesKHR(const VkExternalFencePropertiesKHR& object, const ApiDumpSettings& settings, int indents);
#if defined(VK_USE_PLATFORM_WIN32_KHR)
...
std::ostream& dump_text_VkPhysicalDeviceIDPropertiesKHR(const VkPhysicalDeviceIDPropertiesKHR& object, const ApiDumpSettings& settings, int indents);
#if defined(VK_USE_PLATFORM_WIN32_KHR)
...
std::ostream& dump_text_VkMemoryDedicatedRequirementsKHR(const VkMemoryDedicatedRequirementsKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkMemoryDedicatedAllocateInfoKHR(const VkMemoryDedicatedAllocateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkExportFenceCreateInfoKHR(const VkExportFenceCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkBufferMemoryRequirementsInfo2KHR(const VkBufferMemoryRequirementsInfo2KHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkPhysicalDeviceExternalSemaphoreInfoKHR(const VkPhysicalDeviceExternalSemaphoreInfoKHR& object, const ApiDumpSettings& settings, int indents);
std::ostream& dump_text_VkExternalSemaphorePropertiesKHR(const VkExternalSemaphorePropertiesKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkExternalMemoryPropertiesKHR(const VkExternalMemoryPropertiesKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkPhysicalDeviceExternalImageFormatInfoKHR(const VkPhysicalDeviceExternalImageFormatInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkExternalImageFormatPropertiesKHR(const VkExternalImageFormatPropertiesKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkPhysicalDeviceExternalBufferInfoKHR(const VkPhysicalDeviceExternalBufferInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkExternalBufferPropertiesKHR(const VkExternalBufferPropertiesKHR& object, const ApiDumpSettings& settings, int indents);
#if defined(VK_USE_PLATFORM_WIN32_KHR)
...
std::ostream& dump_text_VkExternalMemoryImageCreateInfoKHR(const VkExternalMemoryImageCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkExternalMemoryBufferCreateInfoKHR(const VkExternalMemoryBufferCreateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkExportMemoryAllocateInfoKHR(const VkExportMemoryAllocateInfoKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkPhysicalDevice16BitStorageFeaturesKHR(const VkPhysicalDevice16BitStorageFeaturesKHR& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_text_VkSemaphoreImportFlagBitsKHR(VkSemaphoreImportFlagBitsKHR object, const ApiDumpSettings& settings, int indents)
{
    bool is_first = true;
    //settings.formatNameType(stream, indents, name, type_string) << object;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_text_bitmaskOption("VK_SEMAPHORE_IMPORT_TEMPORARY_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
std::ostream& dump_text_VkExternalMemoryHandleTypeFlagBitsKHR(VkExternalMemoryHandleTypeFlagBitsKHR object, const ApiDumpSettings& settings, int indents)
{
    bool is_first = true;
    //settings.formatNameType(stream, indents, name, type_string) << object;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHR", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHR", settings.stream(), is_first);
    if(object & 4)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHR", settings.stream(), is_first);
    if(object & 8)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT_KHR", settings.stream(), is_first);
    if(object & 16)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT_KHR", settings.stream(), is_first);
    if(object & 32)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT_KHR", settings.stream(), is_first);
    if(object & 64)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
std::ostream& dump_text_VkFenceImportFlagBitsKHR(VkFenceImportFlagBitsKHR object, const ApiDumpSettings& settings, int indents)
{
    bool is_first = true;
    //settings.formatNameType(stream, indents, name, type_string) << object;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_text_bitmaskOption("VK_FENCE_IMPORT_TEMPORARY_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
std::ostream& dump_text_VkExternalSemaphoreHandleTypeFlagBitsKHR(VkExternalSemaphoreHandleTypeFlagBitsKHR object, const ApiDumpSettings& settings, int indents)
{
    bool is_first = true;
    //settings.formatNameType(stream, indents, name, type_string) << object;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT_KHR", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHR", settings.stream(), is_first);
    if(object & 4)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHR", settings.stream(), is_first);
    if(object & 8)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT_KHR", settings.stream(), is_first);
    if(object & 16)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_SYNC_FD_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
std::ostream& dump_text_VkExternalFenceHandleTypeFlagBitsKHR(VkExternalFenceHandleTypeFlagBitsKHR object, const ApiDumpSettings& settings, int indents)
{
    bool is_first = true;
    //settings.formatNameType(stream, indents, name, type_string) << object;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_FD_BIT_KHR", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHR", settings.stream(), is_first);
    if(object & 4)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHR", settings.stream(), is_first);
    if(object & 8)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_FENCE_HANDLE_TYPE_SYNC_FD_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
std::ostream& dump_text_VkExternalFenceFeatureFlagBitsKHR(VkExternalFenceFeatureFlagBitsKHR object, const ApiDumpSettings& settings, int indents)
{
    bool is_first = true;
    //settings.formatNameType(stream, indents, name, type_string) << object;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_FENCE_FEATURE_EXPORTABLE_BIT_KHR", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_FENCE_FEATURE_IMPORTABLE_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
std::ostream& dump_text_VkExternalSemaphoreFeatureFlagBitsKHR(VkExternalSemaphoreFeatureFlagBitsKHR object, const ApiDumpSettings& settings, int indents)
{
    bool is_first = true;
    //settings.formatNameType(stream, indents, name, type_string) << object;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT_KHR", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
std::ostream& dump_text_VkExternalMemoryFeatureFlagBitsKHR(VkExternalMemoryFeatureFlagBitsKHR object, const ApiDumpSettings& settings, int indents)
{
    bool is_first = true;
    //settings.formatNameType(stream, indents, name, type_string) << object;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_KHR", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_KHR", settings.stream(), is_first);
    if(object & 4)
        is_first = dump_text_bitmaskOption("VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_KHR", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream();
}
...
inline std::ostream& dump_text_VkSemaphoreImportFlagsKHR(VkSemaphoreImportFlagsKHR object, const ApiDumpSettings& settings, int indents)
{
    return dump_text_VkSemaphoreImportFlagBitsKHR((VkSemaphoreImportFlagBitsKHR) object, settings, indents);
}
...
inline std::ostream& dump_text_VkExternalFenceHandleTypeFlagsKHR(VkExternalFenceHandleTypeFlagsKHR object, const ApiDumpSettings& settings, int indents)
{
    return dump_text_VkExternalFenceHandleTypeFlagBitsKHR((VkExternalFenceHandleTypeFlagBitsKHR) object, settings, indents);
}
...
inline std::ostream& dump_text_VkExternalFenceFeatureFlagsKHR(VkExternalFenceFeatureFlagsKHR object, const ApiDumpSettings& settings, int indents)
{
    return dump_text_VkExternalFenceFeatureFlagBitsKHR((VkExternalFenceFeatureFlagBitsKHR) object, settings, indents);
}
...
inline std::ostream& dump_text_VkExternalMemoryHandleTypeFlagsKHR(VkExternalMemoryHandleTypeFlagsKHR object, const ApiDumpSettings& settings, int indents)
{
    return dump_text_VkExternalMemoryHandleTypeFlagBitsKHR((VkExternalMemoryHandleTypeFlagBitsKHR) object, settings, indents);
}
inline std::ostream& dump_text_VkExternalSemaphoreHandleTypeFlagsKHR(VkExternalSemaphoreHandleTypeFlagsKHR object, const ApiDumpSettings& settings, int indents)
{
    return dump_text_VkExternalSemaphoreHandleTypeFlagBitsKHR((VkExternalSemaphoreHandleTypeFlagBitsKHR) object, settings, indents);
}
...
inline std::ostream& dump_text_VkFenceImportFlagsKHR(VkFenceImportFlagsKHR object, const ApiDumpSettings& settings, int indents)
{
    return dump_text_VkFenceImportFlagBitsKHR((VkFenceImportFlagBitsKHR) object, settings, indents);
}
inline std::ostream& dump_text_VkExternalSemaphoreFeatureFlagsKHR(VkExternalSemaphoreFeatureFlagsKHR object, const ApiDumpSettings& settings, int indents)
{
    return dump_text_VkExternalSemaphoreFeatureFlagBitsKHR((VkExternalSemaphoreFeatureFlagBitsKHR) object, settings, indents);
}
...
inline std::ostream& dump_text_VkExternalMemoryFeatureFlagsKHR(VkExternalMemoryFeatureFlagsKHR object, const ApiDumpSettings& settings, int indents)
{
    return dump_text_VkExternalMemoryFeatureFlagBitsKHR((VkExternalMemoryFeatureFlagBitsKHR) object, settings, indents);
}
...
std::ostream& dump_text_VkImportSemaphoreFdInfoKHR(const VkImportSemaphoreFdInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkSemaphoreImportFlagsKHR>(object.flags, settings, "VkSemaphoreImportFlagsKHR", "flags", indents + 1, dump_text_VkSemaphoreImportFlagsKHR);
    dump_text_value<const VkExternalSemaphoreHandleTypeFlagBitsKHR>(object.handleType, settings, "VkExternalSemaphoreHandleTypeFlagBitsKHR", "handleType", indents + 1, dump_text_VkExternalSemaphoreHandleTypeFlagBitsKHR);
...
std::ostream& dump_text_VkExportSemaphoreCreateInfoKHR(const VkExportSemaphoreCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkExternalSemaphoreHandleTypeFlagsKHR>(object.handleTypes, settings, "VkExternalSemaphoreHandleTypeFlagsKHR", "handleTypes", indents + 1, dump_text_VkExternalSemaphoreHandleTypeFlagsKHR);
    return settings.stream();
}
std::ostream& dump_text_VkAllocationCallbacks(const VkAllocationCallbacks& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_text_VkImportMemoryFdInfoKHR(const VkImportMemoryFdInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkExternalMemoryHandleTypeFlagBitsKHR>(object.handleType, settings, "VkExternalMemoryHandleTypeFlagBitsKHR", "handleType", indents + 1, dump_text_VkExternalMemoryHandleTypeFlagBitsKHR);
    dump_text_value<const int>(object.fd, settings, "int", "fd", indents + 1, dump_text_int);
    return settings.stream();
}
#if defined(VK_USE_PLATFORM_WIN32_KHR)
...
std::ostream& dump_text_VkPhysicalDeviceExternalFenceInfoKHR(const VkPhysicalDeviceExternalFenceInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkExternalFenceHandleTypeFlagBitsKHR>(object.handleType, settings, "VkExternalFenceHandleTypeFlagBitsKHR", "handleType", indents + 1, dump_text_VkExternalFenceHandleTypeFlagBitsKHR);
    return settings.stream();
}
std::ostream& dump_text_VkExternalFencePropertiesKHR(const VkExternalFencePropertiesKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkExternalFenceHandleTypeFlagsKHR>(object.exportFromImportedHandleTypes, settings, "VkExternalFenceHandleTypeFlagsKHR", "exportFromImportedHandleTypes", indents + 1, dump_text_VkExternalFenceHandleTypeFlagsKHR);
    dump_text_value<const VkExternalFenceHandleTypeFlagsKHR>(object.compatibleHandleTypes, settings, "VkExternalFenceHandleTypeFlagsKHR", "compatibleHandleTypes", indents + 1, dump_text_VkExternalFenceHandleTypeFlagsKHR);
    dump_text_value<const VkExternalFenceFeatureFlagsKHR>(object.externalFenceFeatures, settings, "VkExternalFenceFeatureFlagsKHR", "externalFenceFeatures", indents + 1, dump_text_VkExternalFenceFeatureFlagsKHR);
    return settings.stream();
}
#if defined(VK_USE_PLATFORM_WIN32_KHR)
std::ostream& dump_text_VkD3D12FenceSubmitInfoKHR(const VkD3D12FenceSubmitInfoKHR& object, const ApiDumpSettings& settings, int indents)
...
std::ostream& dump_text_VkPhysicalDeviceIDPropertiesKHR(const VkPhysicalDeviceIDPropertiesKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_array<const uint8_t>(object.deviceLUID, 8, settings, "uint8_t[VK_LUID_SIZE_KHR]", "uint8_t", "deviceLUID", indents + 1, dump_text_uint8_t);
...
std::ostream& dump_text_VkExportFenceCreateInfoKHR(const VkExportFenceCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkExternalFenceHandleTypeFlagsKHR>(object.handleTypes, settings, "VkExternalFenceHandleTypeFlagsKHR", "handleTypes", indents + 1, dump_text_VkExternalFenceHandleTypeFlagsKHR);
    return settings.stream();
}
std::ostream& dump_text_VkSemaphoreCreateInfo(const VkSemaphoreCreateInfo& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_text_VkImportFenceWin32HandleInfoKHR(const VkImportFenceWin32HandleInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkFenceImportFlagsKHR>(object.flags, settings, "VkFenceImportFlagsKHR", "flags", indents + 1, dump_text_VkFenceImportFlagsKHR);
    dump_text_value<const VkExternalFenceHandleTypeFlagBitsKHR>(object.handleType, settings, "VkExternalFenceHandleTypeFlagBitsKHR", "handleType", indents + 1, dump_text_VkExternalFenceHandleTypeFlagBitsKHR);
    dump_text_value<const HANDLE>(object.handle, settings, "HANDLE", "handle", indents + 1, dump_text_HANDLE);
    dump_text_value<const LPCWSTR>(object.name, settings, "LPCWSTR", "name", indents + 1, dump_text_LPCWSTR);
    return settings.stream();
...
std::ostream& dump_text_VkExternalSemaphorePropertiesKHR(const VkExternalSemaphorePropertiesKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkExternalSemaphoreHandleTypeFlagsKHR>(object.exportFromImportedHandleTypes, settings, "VkExternalSemaphoreHandleTypeFlagsKHR", "exportFromImportedHandleTypes", indents + 1, dump_text_VkExternalSemaphoreHandleTypeFlagsKHR);
    dump_text_value<const VkExternalSemaphoreHandleTypeFlagsKHR>(object.compatibleHandleTypes, settings, "VkExternalSemaphoreHandleTypeFlagsKHR", "compatibleHandleTypes", indents + 1, dump_text_VkExternalSemaphoreHandleTypeFlagsKHR);
    dump_text_value<const VkExternalSemaphoreFeatureFlagsKHR>(object.externalSemaphoreFeatures, settings, "VkExternalSemaphoreFeatureFlagsKHR", "externalSemaphoreFeatures", indents + 1, dump_text_VkExternalSemaphoreFeatureFlagsKHR);
    return settings.stream();
}
std::ostream& dump_text_VkDescriptorUpdateTemplateCreateInfoKHR(const VkDescriptorUpdateTemplateCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_text_VkExternalMemoryPropertiesKHR(const VkExternalMemoryPropertiesKHR& object, const ApiDumpSettings& settings, int indents)
{
    if(settings.showAddress())
        ...
        settings.stream() << "address:\n";
    dump_text_value<const VkExternalMemoryFeatureFlagsKHR>(object.externalMemoryFeatures, settings, "VkExternalMemoryFeatureFlagsKHR", "externalMemoryFeatures", indents + 1, dump_text_VkExternalMemoryFeatureFlagsKHR);
    dump_text_value<const VkExternalMemoryHandleTypeFlagsKHR>(object.exportFromImportedHandleTypes, settings, "VkExternalMemoryHandleTypeFlagsKHR", "exportFromImportedHandleTypes", indents + 1, dump_text_VkExternalMemoryHandleTypeFlagsKHR);
    dump_text_value<const VkExternalMemoryHandleTypeFlagsKHR>(object.compatibleHandleTypes, settings, "VkExternalMemoryHandleTypeFlagsKHR", "compatibleHandleTypes", indents + 1, dump_text_VkExternalMemoryHandleTypeFlagsKHR);
    return settings.stream();
}
std::ostream& dump_text_VkRenderPassCreateInfo(const VkRenderPassCreateInfo& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_text_VkExternalImageFormatPropertiesKHR(const VkExternalImageFormatPropertiesKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkExternalMemoryPropertiesKHR>(object.externalMemoryProperties, settings, "VkExternalMemoryPropertiesKHR", "externalMemoryProperties", indents + 1, dump_text_VkExternalMemoryPropertiesKHR);
    return settings.stream();
}
std::ostream& dump_text_VkObjectTableIndexBufferEntryNVX(const VkObjectTableIndexBufferEntryNVX& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_text_VkExternalMemoryImageCreateInfoKHR(const VkExternalMemoryImageCreateInfoKHR& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_text_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_text_VkStructureType);
    dump_text_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_text_void);
    dump_text_value<const VkExternalMemoryHandleTypeFlagsKHR>(object.handleTypes, settings, "VkExternalMemoryHandleTypeFlagsKHR", "handleTypes", indents + 1, dump_text_VkExternalMemoryHandleTypeFlagsKHR);
    return settings.stream();
}
std::ostream& dump_text_VkPipelineTessellationStateCreateInfo(const VkPipelineTessellationStateCreateInfo& object, const ApiDumpSettings& settings, int indents)
{
...
#endif // VK_USE_PLATFORM_VI_NN
#if defined(VK_USE_PLATFORM_WIN32_KHR)
std::ostream& dump_text_vkGetMemoryWin32HandlePropertiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHR handleType, HANDLE handle, VkMemoryWin32HandlePropertiesKHR* pMemoryWin32HandleProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    {
        dump_text_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_text_VkDevice);
        dump_text_value<const VkExternalMemoryHandleTypeFlagBitsKHR>(handleType, settings, "VkExternalMemoryHandleTypeFlagBitsKHR", "handleType", 1, dump_text_VkExternalMemoryHandleTypeFlagBitsKHR);
...
std::ostream& dump_text_vkGetMemoryFdPropertiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHR handleType, int fd, VkMemoryFdPropertiesKHR* pMemoryFdProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
...
std::ostream& dump_text_vkGetPhysicalDeviceExternalSemaphorePropertiesKHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalSemaphoreInfoKHR* pExternalSemaphoreInfo, VkExternalSemaphorePropertiesKHR* pExternalSemaphoreProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    {
        dump_text_value<const VkPhysicalDevice>(physicalDevice, settings, "VkPhysicalDevice", "physicalDevice", 1, dump_text_VkPhysicalDevice);
        dump_text_pointer<const VkPhysicalDeviceExternalSemaphoreInfoKHR>(pExternalSemaphoreInfo, settings, "const VkPhysicalDeviceExternalSemaphoreInfoKHR*", "pExternalSemaphoreInfo", 1, dump_text_VkPhysicalDeviceExternalSemaphoreInfoKHR);
        dump_text_pointer<const VkExternalSemaphorePropertiesKHR>(pExternalSemaphoreProperties, settings, "VkExternalSemaphorePropertiesKHR*", "pExternalSemaphoreProperties", 1, dump_text_VkExternalSemaphorePropertiesKHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_text_vkGetImageSparseMemoryRequirements2KHR(ApiDumpInstance& dump_inst, VkDevice device, const VkImageSparseMemoryRequirementsInfo2KHR* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2KHR* pSparseMemoryRequirements)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    {
        dump_text_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_text_VkDevice);
        dump_text_pointer<const VkImageSparseMemoryRequirementsInfo2KHR>(pInfo, settings, "const VkImageSparseMemoryRequirementsInfo2KHR*", "pInfo", 1, dump_text_VkImageSparseMemoryRequirementsInfo2KHR);
        ...
        dump_text_array<const VkSparseImageMemoryRequirements2KHR>(pSparseMemoryRequirements, *pSparseMemoryRequirementCount, settings, "VkSparseImageMemoryRequirements2KHR*", "VkSparseImageMemoryRequirements2KHR", "pSparseMemoryRequirements", 1, dump_text_VkSparseImageMemoryRequirements2KHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_text_vkGetImageMemoryRequirements2KHR(ApiDumpInstance& dump_inst, VkDevice device, const VkImageMemoryRequirementsInfo2KHR* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    {
        dump_text_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_text_VkDevice);
        dump_text_pointer<const VkImageMemoryRequirementsInfo2KHR>(pInfo, settings, "const VkImageMemoryRequirementsInfo2KHR*", "pInfo", 1, dump_text_VkImageMemoryRequirementsInfo2KHR);
        dump_text_pointer<const VkMemoryRequirements2KHR>(pMemoryRequirements, settings, "VkMemoryRequirements2KHR*", "pMemoryRequirements", 1, dump_text_VkMemoryRequirements2KHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_text_vkGetBufferMemoryRequirements2KHR(ApiDumpInstance& dump_inst, VkDevice device, const VkBufferMemoryRequirementsInfo2KHR* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    {
        dump_text_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_text_VkDevice);
        dump_text_pointer<const VkBufferMemoryRequirementsInfo2KHR>(pInfo, settings, "const VkBufferMemoryRequirementsInfo2KHR*", "pInfo", 1, dump_text_VkBufferMemoryRequirementsInfo2KHR);
        dump_text_pointer<const VkMemoryRequirements2KHR>(pMemoryRequirements, settings, "VkMemoryRequirements2KHR*", "pMemoryRequirements", 1, dump_text_VkMemoryRequirements2KHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_text_vkGetPhysicalDeviceExternalFencePropertiesKHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalFenceInfoKHR* pExternalFenceInfo, VkExternalFencePropertiesKHR* pExternalFenceProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    {
        dump_text_value<const VkPhysicalDevice>(physicalDevice, settings, "VkPhysicalDevice", "physicalDevice", 1, dump_text_VkPhysicalDevice);
        dump_text_pointer<const VkPhysicalDeviceExternalFenceInfoKHR>(pExternalFenceInfo, settings, "const VkPhysicalDeviceExternalFenceInfoKHR*", "pExternalFenceInfo", 1, dump_text_VkPhysicalDeviceExternalFenceInfoKHR);
        dump_text_pointer<const VkExternalFencePropertiesKHR>(pExternalFenceProperties, settings, "VkExternalFencePropertiesKHR*", "pExternalFenceProperties", 1, dump_text_VkExternalFencePropertiesKHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_text_vkGetPhysicalDeviceExternalBufferPropertiesKHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalBufferInfoKHR* pExternalBufferInfo, VkExternalBufferPropertiesKHR* pExternalBufferProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    settings.stream() << "Thread " << dump_inst.threadID() << ", Frame " << dump_inst.frameCount() << ":\n";
    ...
    {
        dump_text_value<const VkPhysicalDevice>(physicalDevice, settings, "VkPhysicalDevice", "physicalDevice", 1, dump_text_VkPhysicalDevice);
        dump_text_pointer<const VkPhysicalDeviceExternalBufferInfoKHR>(pExternalBufferInfo, settings, "const VkPhysicalDeviceExternalBufferInfoKHR*", "pExternalBufferInfo", 1, dump_text_VkPhysicalDeviceExternalBufferInfoKHR);
        dump_text_pointer<const VkExternalBufferPropertiesKHR>(pExternalBufferProperties, settings, "VkExternalBufferPropertiesKHR*", "pExternalBufferProperties", 1, dump_text_VkExternalBufferPropertiesKHR);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
